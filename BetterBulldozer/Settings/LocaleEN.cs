    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(BetterBulldozerModSettings.AutomaticRemovalFencesAndHedges)), "Automitically removes fences and hedges from buildings plopped, spawned, and when they update. They still appear temporarily while moving or plopping." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(BetterBulldozerModSettings.AutomaticRemovalBrandingObjects)), "Automitically removes branding objects and advertisements from buildings plopped, spawned, and when they update. They still appear temporarily while moving or plopping." },
