    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(BetterBulldozerModSettings.AutomaticRemovalFencesAndHedges)), "Automatically removes fences and hedges from buildings plopped, spawned, and when they update. They still appear temporarily while moving or plopping." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(BetterBulldozerModSettings.AutomaticRemovalBrandingObjects)), "Automatically removes branding objects and advertisements from buildings plopped, spawned, and when they update. They still appear temporarily while moving or plopping." },
                ...
                { TooltipDescriptionKey("Similar"), "Selects all sub-elements in a similar category within the building, subbuilding, extension or network and 'permanently removes' them. Categories include: trees, plants, street lights, trash bins, branding objects and advertisements, activity locations, and all hedges and fences. (i.e. all trees in this asset). 'Permanent removal' means whenever they are regenerated they will automatically be removed again soon afterwards." },
